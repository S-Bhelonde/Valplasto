...
import { FaTint, FaHome, FaRupeeSign, FaCog, FaHouseDamage, FaHandHoldingMedical } from 'react-icons/fa';
import waterproffing from '../assets/waterproofing.png';
...
const WaterproofingSolutions = () => {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif' }}>
            {/* Top Section */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px', flexWrap: 'wrap' }}>
                <div style={{ width: '100%', maxWidth: '600px', padding: '20px' }}>
                    <h2>Waterproofing Solutions by Valplasto Enterprises</h2>
                    <p>
                        Waterproofing one’s home is an essential part of any home building project. Waterproofing products and solutions are essential
                        for protecting various surfaces from water damage and moisture infiltration...
                    </p>
                </div>
                <div style={{ width: '100%', maxWidth: '500px', padding: '20px' }}>
                    <img src={waterproffing} alt="Waterproofing Solutions" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
            </div>
            ...
            <div style={{ padding: '40px' }}>
                ...
                <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <div style={{
                        ...
                        <img src={waterproffing} alt="New Construction Icon" style={{ width: '80px', marginBottom: '20px' }} />
                        ...
                        <a href="#" style={{ display: 'inline-block', marginTop: '20px', fontWeight: 'bold', color: '#000', textDecoration: 'underline' }}>
                            KNOW MORE
                        </a>
                    </div>
                    ...
                    <div style={{
                        ...
                        <img src={waterproffing} alt="Repair Renovation Icon" style={{ width: '80px', marginBottom: '20px' }} />
            ...
            {/* New Homeowners and Existing Homeowners Side by Side */}
            <div style={{ padding: '40px' }}>
                <h2 style={{ textAlign: 'center', fontSize: '28px', fontWeight: 'bold', marginBottom: '30px' }}>Who Should Use Waterproofing?</h2>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '30px' }}>
                    ...
                    <div style={{
                        ...
                        <h4 style={{ textAlign: 'center', marginBottom: '30px' }}>Why waterproofing is great for new homeowners:</h4>
                    ...
                    <div style={{
                        ...
                        <h4 style={{ textAlign: 'center', marginBottom: '30px' }}>Why waterproofing helps existing homeowners:</h4>
                        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
